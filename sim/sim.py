...
class EpistemicNetworkSimulation():
    ...
    def _sim_action(self, sim_round: int):
        ...
        # It will be the total the brier score of the agents as they came in.
        ...
        # populations of the latter configuration are still worse off.
    ...
    def _save_brier_stats(self):
        ...
        self.max_obtainable_brier_penalty += n
